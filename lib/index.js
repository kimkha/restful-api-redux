...
exports.convertItemState = exports.convertRestItemState = exports.convertRestListState = exports.isLoginState = exports.convertApiState = exports.apiLoginBuilder = exports.apiRestBuilder = exports.apiActionBuilder = exports.apiReducer = exports.apiMiddleware = exports.API_REDUX_KEY = exports.API_ACTION_TYPE = undefined;
...
var convertItemState = exports.convertItemState = function convertItemState(state, key, id) {
  var apiResult = convertApiState(state, key);
  if (apiResult.response) {
    var data = apiResult.response.data;
    return data && data[id];
