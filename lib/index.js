...
exports.convertApiStatus = exports.convertRestItemState = exports.convertRestListState = exports.isLoginState = exports.convertApiState = exports.apiLoginBuilder = exports.apiRestBuilder = exports.apiActionBuilder = exports.apiReducer = exports.apiMiddleware = exports.API_REDUX_KEY = exports.API_ACTION_TYPE = undefined;
...
var apiRestBuilder = exports.apiRestBuilder = function apiRestBuilder(key, url, trackingId) {
  var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
  return (0, _defineProperty3.default)({}, _constants.API_ACTION_TYPE, {
    key: key,
    endpoint: url,
