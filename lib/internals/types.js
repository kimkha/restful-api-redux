...
var baseTypes = ['LOADING', 'SUCCESS', 'FAILURE', 'EVENTMSG'];
var specialTypes = [_constants.API_PROFILE_KEY, _constants.API_LOGIN_KEY].map(function (k) {
  return _constants.API_ACTION_TYPE + '/' + k.toUpperCase();
});
...
var isApiType = exports.isApiType = function isApiType(type) {
  return type.indexOf(_constants.API_ACTION_TYPE + '/') === 0 && !specialTypes.some(function (t) {
